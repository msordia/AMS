...
const userReducer = (state = initialState, action) => {
	switch( action.type ) {
		...
		case 'actualizarPefil':
			return {loggedIn: true, ID: action.payload.ID, FechaNacimiento: action.payload.fechaNacimiento, correo: action.payload.correo, Nombre: action.payload.nombre, Sexo: action.payload.sexo, Telefono: action.payload.telefono}
		default:
			return state;
	}
};
